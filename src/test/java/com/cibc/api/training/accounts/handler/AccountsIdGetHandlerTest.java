...
@Ignore
public class AccountsIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(AccountsIdGetHandlerTest.class);
    ...
    @Test
    public void testAccountsIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/accounts/10";
