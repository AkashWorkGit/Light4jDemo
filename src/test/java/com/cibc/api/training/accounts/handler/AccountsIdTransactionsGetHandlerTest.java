...
@Ignore
public class AccountsIdTransactionsGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(AccountsIdTransactionsGetHandlerTest.class);
    ...
    @Test
    public void testAccountsIdTransactionsGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/accounts/75/transactions";
